<template>
  <div>
    ...
    <section class="page-heading">
      <img
        src="@/assets/images/subscribe-page-heading.png"
        class="img-fluid"
        alt=""
      />
      <div class="page-heading-info">
        <div>
          <h1 class="text-uppercase">Subscribe</h1>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-sm-10 m-auto">
            <div class="mb-5 text-center">
              <p>
                With our rigorous observation of consumer behavior and our
                meticulous care for every detail, we strive to understand and
                satisfy the ever increasing demands of our clients.
              </p>
              <h4 class="text-uppercase fw-light">BAIC, Always Be With You</h4>
            </div>
            <Form
              as="form"
              class="form"
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <Field
                        ...
                        v-model="initialData.mediaIntroduction"
                      ></Field>
                    </div>
                  </div>
                </div>
...
import { useSubscribeStore } from "../../store/modules/subcribe";
export default {
  components: {
    Field,
    Form,
  ...
  data() {
    ...
    return {
      schema,
      initialData,
      subscribeStore: useSubscribeStore(),
    };
  },
  methods: {
    onSubmit(values, actions) {
      console.log("media", values);
      this.subscribeStore.post(values);
      actions.resetForm();
    },
  },
};
